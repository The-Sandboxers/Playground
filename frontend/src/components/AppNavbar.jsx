...
export default function AppNavbar(){
    ...
    return(
        <div>
            <nav className="bg-transparent border-background z-10 top-0 left-0 w-full">
                <div className="max-w-screen flex flex-wrap items-center justify-between mx-8 p-4">
                    ...
                    <div >
                        <Button size="lg" variant="secondary" className="font-black text-md" onClick={() => navigate("/application/profile")}>Profile</Button>
                    </div>
                </div>
            </nav>
